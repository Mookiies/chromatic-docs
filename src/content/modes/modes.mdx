...
The `options` configuration object is only available in Storybook 9. See the versioned Storybook documentation for the [viewport](https://storybook.js.org/docs/7/essentials/viewport) and [backgrounds](https://storybook.js.org/docs/9/essentials/backgrounds) for more information on configuring these addons.
